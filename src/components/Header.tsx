      ...
      <div className="flex items-center gap-4 max-w-5xl mx-auto w-full">
        <div className="relative">
          <div className="w-12 h-12 rounded-full bg-slate-950 flex items-center justify-center shadow-[0_0_15px_rgba(0,210,255,0.3)] overflow-hidden border-2 border-[#00d2ff]">
            <div className="absolute inset-0 bg-gradient-to-br from-[#00d2ff]/20 to-[#9d50bb]/20 animate-pulse"></div>
        ...
        <div className="flex-1">
          <h1 className="font-bold text-xl tracking-tight text-[#003366]">MSU AI</h1>
        ...
        <div className="hidden sm:flex items-center gap-3">
          <a 
            ...
            className="px-3 py-1 rounded-full bg-slate-100 border border-slate-200 hover:bg-slate-200 transition-colors"
          >
            <span className="text-[10px] font-bold text-slate-500 tracking-widest uppercase">Official Website</span>
          </a>
        </div>
      </div>
    </header>
